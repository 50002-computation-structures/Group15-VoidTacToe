module tictactoe_ws2812_display #(
        ...
        parameter integer CHAIN_PIXEL_OFFSET = 0,
    ...
    function automatic integer wrapped_chain_pixel_index(input integer chain_pixel_index);
        begin
            wrapped_chain_pixel_index = chain_pixel_index + CHAIN_PIXEL_OFFSET;
            if (wrapped_chain_pixel_index >= NUM_PIXELS) begin
                wrapped_chain_pixel_index = wrapped_chain_pixel_index - NUM_PIXELS;
            end else if (wrapped_chain_pixel_index < 0) begin
                wrapped_chain_pixel_index = wrapped_chain_pixel_index + NUM_PIXELS;
            end
        end
    endfunction

    function automatic logic [23:0] pixel_color_for_index(input integer chain_pixel_index);
        integer pixel_index;
        ...
        logic [15:0] bitmap;
        begin
            pixel_index = wrapped_chain_pixel_index(chain_pixel_index);
