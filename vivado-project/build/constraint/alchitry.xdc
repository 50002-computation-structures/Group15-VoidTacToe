...
set_property PACKAGE_PIN M1 [get_ports {cell_switch[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[0]}]
set_property PULLDOWN true [get_ports {cell_switch[0]}]

set_property PACKAGE_PIN P13 [get_ports {cell_switch[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[1]}]
set_property PULLDOWN true [get_ports {cell_switch[1]}]

set_property PACKAGE_PIN N12 [get_ports {cell_switch[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[2]}]
set_property PULLDOWN true [get_ports {cell_switch[2]}]

set_property PACKAGE_PIN M2 [get_ports {cell_switch[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[3]}]
set_property PULLDOWN true [get_ports {cell_switch[3]}]

set_property PACKAGE_PIN N13 [get_ports {cell_switch[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[4]}]
set_property PULLDOWN true [get_ports {cell_switch[4]}]

set_property PACKAGE_PIN N11 [get_ports {cell_switch[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[5]}]
set_property PULLDOWN true [get_ports {cell_switch[5]}]

set_property PACKAGE_PIN P3 [get_ports {cell_switch[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[6]}]
set_property PULLDOWN true [get_ports {cell_switch[6]}]

set_property PACKAGE_PIN R11 [get_ports {cell_switch[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[7]}]
set_property PULLDOWN true [get_ports {cell_switch[7]}]

set_property PACKAGE_PIN T12 [get_ports {cell_switch[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cell_switch[8]}]
set_property PULLDOWN true [get_ports {cell_switch[8]}]

set_property PACKAGE_PIN N3 [get_ports {auto_seq_switch}]
set_property IOSTANDARD LVCMOS33 [get_ports {auto_seq_switch}]
set_property PULLDOWN true [get_ports {auto_seq_switch}]

set_property PACKAGE_PIN P11 [get_ports {p11_passthrough_in}]
set_property IOSTANDARD LVCMOS33 [get_ports {p11_passthrough_in}]
set_property PULLDOWN true [get_ports {p11_passthrough_in}]

set_property PACKAGE_PIN P5 [get_ports {p5_passthrough_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {p5_passthrough_out}]
...
# clk => 100000000Hz
create_clock -period 10.0 -name clk_100 -waveform {0.000 5.0} [get_ports clk]
create_generated_clock -name clk_10m -source [get_ports clk] -divide_by 10 [get_pins {alchitry_top/clk_10m_q_reg/Q}]
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks clk_100]
...
set_property PACKAGE_PIN R10 [get_ports {ws2812_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {ws2812_out}]

set_property PACKAGE_PIN T3 [get_ports {turn_led_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {turn_led_out}]
