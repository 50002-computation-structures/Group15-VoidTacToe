...
module pc_unit (
    ...
    always @* begin
        ...
        pcsel_out_sig = 1'h0;
        pc_4sxtc_sig = 1'h0;
        pc_4raw = (($bits(D_pc_q) > $bits(3'h4) ? $bits(D_pc_q) : $bits(3'h4)) + 1)'(D_pc_q + 3'h4);
        pc_4sig = {D_pc_q[5'h1f], pc_4raw[5'h1e:1'h0]};
        pc_4sxtc32_sig = (($bits(pc_4raw) > $bits({{4'he{id[4'hf]}}, id[4'hf:1'h0], 2'h0}) ? $bits(pc_4raw) : $bits({{4'he{id[4'hf]}}, id[4'hf:1'h0], 2'h0})) + 1)'(pc_4raw + {{4'he{id[4'hf]}}, id[4'hf:1'h0], 2'h0});
        ...
        case (pcsel)
            ...
            3'h2: begin
                pcsel_out_sig = {D_pc_q[5'h1f] & reg_data_1[5'h1f], reg_data_1[5'h1e:2'h2], 2'h0};
            end
            3'h3: begin
