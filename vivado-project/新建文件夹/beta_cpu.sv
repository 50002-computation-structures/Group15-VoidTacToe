...
module beta_cpu (
    ...
    logic M_alu_system_outz;
    logic M_alu_system_outv;
    logic M_alu_system_outn;
    ...
    alu alu_system (
        ...
        .outz(M_alu_system_outz),
        .outv(M_alu_system_outv),
        .outn(M_alu_system_outn)
    );
    ...
    always @* begin
        ...
        if (M_control_system_asel) begin
            asel_out = M_pc_system_pc_4_sxtc;
        end else begin
            asel_out = M_regfile_system_rd1;
        end
        if (M_control_system_bsel) begin
        ...
        wr = M_control_system_wr;
        ia = M_pc_system_ia;
        debug[1'h0][4'hf:1'h0] = M_pc_system_pc_4_sxtc[4'hf:1'h0];
